...
{
    public class PreValidateUpdateIncidentBusinessConfiguratorTests : BusinessConfiguratorTestBase
    {
        ...
        public void Init()
        {
            Configurator = new PreValidateUpdateIncidentBusinessConfigurator();
        }
        ...
        [Test]
        public void Configure_ShouldNotReturnAnyBusinessAgent_WhenResponsibleContactIsNotModified()
        {
        ...
        [Test]
        public void Configure_ShouldReturnOnlyIncidentCustomerContactValidator_WhenResponsibleContactIsModified()
        {
